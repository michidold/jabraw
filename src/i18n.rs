...
const EN: Strings = Strings {
    ...
    bluetooth_note: "Connected over Bluetooth — firmware and serial number\nare only available through the USB dongle.",
    setting: "Setting",
    value: "Value",
...
const DE: Strings = Strings {
    ...
    firmware: "Firmware",
    serial: "Seriennummer",
    bluetooth_note: "Über Bluetooth verbunden — Firmware und Seriennummer\nliefert nur der USB-Dongle.",
    setting: "Einstellung",
    value: "Wert",
